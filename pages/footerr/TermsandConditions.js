...
- Client: Any individual or entity using the services of Resume Intellect.
- Company: Resume Intellect.
- Services: Resume writing, career coaching, LinkedIn profile optimization, and other career-related services provided by Resume Intellect.

<h1 className="text-lg font-semibold my-2 mt-5 ">2. Use of Services</h1>

- Clients must provide accurate and complete information when utilizing our services.
- Services are intended for personal use only. Redistribution or resale of our services is prohibited.
- Clients agree to use our services in a manner consistent with all applicable laws and regulations.

<h1 className="text-lg font-semibold my-2 mt-5 ">3. Payment and Refunds</h1>

- Payment for services must be made in full before the commencement of any work.
- All fees are non-refundable unless otherwise stated in a specific service agreement.
- In case of dissatisfaction with our services, clients must contact us within 7 days of receiving the final product. We will make reasonable efforts to address and rectify any issues.

<h1 className="text-lg font-semibold my-2 mt-5 ">4. Intellectual Property</h1>

- All content, materials, and services provided by Resume Intellect are protected by intellectual property laws.
...
- Resume Intellect respects the privacy and confidentiality of its clients.
...
- Resume Intellect will not be liable for any direct, indirect, incidental, or consequential damages arising out of or in connection with the use of our services.
...
- Resume Intellect reserves the right to modify or update these terms and conditions at any time without prior notice.
...
- These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which Resume Intellect operates.
