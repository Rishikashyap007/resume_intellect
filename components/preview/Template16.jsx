            ...
            <Image
              ...
              <div class="text-left text-white">
                  <div className="mb-8">
                    ...
                    <ContactInfo
                          mainclass=" gap-1 mb-1 text-white mb-5 contact"
              ...
              <div className="mb-8">
                <h2 className="text-xl text-white mb-5 font-bold mb-4" style={{ color: headerColor }}>EDUCATION</h2>
                <div className="mb-4">
              ...
              <div className="mb-8">
                <h2 className="text-xl font-bold text-white mb-4" style={{ color: headerColor }}>SKILLS</h2>
                                ...
                                >
                                  {(provided, snapshot) => (
                                    <div
                                      ...
                                      className={`text-white mb-5 hover:scale-105 transition-transform duration-300 mb-1 ${snapshot.isDragging &&
              ...
              <div className="mb-8">
                <h2 className="text-xl font-bold text-white" style={{ color: headerColor }}>LANGUAGE</h2>
