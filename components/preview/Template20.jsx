...
const Template20 = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-5 bg-white-500 shadow-md">
            <div class="">
                <div className="mb-8 text-right border-l-2 border-gray-600">
                    <h1 className="text-4xl font-bold mb-4 text-slate-700	" style={{ color: headerColor }}>{resumeData.name}</h1>
                ...
                <div class="text-left text-white bg-zinc-700">
                    <div className="mb-8">
                      ...
                      <ContactInfo
                            mainclass=" gap-1 mb-1 text-white mb-5 contact p-10"
                            linkclass="text-l inline-flex items-center gap-1 mr-5 text-m"
        ...
        <div class="flex gap-1 items-start mb-10 border-gray-800">
            <div class=" w-2/3 p-5">
                ...
                <div className="mb-8">
                                  ...
                                  {resumeData.workExperience.map((item, index) => (
                                    ...
                                    >
                                      {(provided, snapshot) => (
                                        ...
                                        >
                                          <div className="justify-between space-y-1 flex">
                  ...
                  <div class=" text-left">
                    ...
                    <div class="border-solid border-b-2 border-black mb-5"></div>	
            ...
            <div class="p-5 w-1/3 bg-zinc-200">
                ...
                <div class="text-left text-white ">
                    <div className="mb-8">
                      ...
                      <ContactInfo
                            ...
                            linkclass="inline-flex items-center gap-1 mr-5 mb-2 text-m"
                            teldata={resumeData.contactInformation}
                            emaildata={resumeData.email}
                            addressdata={resumeData.address}
                            telicon={<MdPhone />}
                ...
                <div class="">
                <div className="mb-8">
                  <h2 className="text-xl text-black mb-5 font-bold" style={{ color: headerColor }}>EDUCATION</h2>
                                    ...
                                    >
                                      {(provided, snapshot) => (
                                        <div
                                          ...
                                          {...provided.draggableProps}
                                          {...provided.dragHandleProps}
                                          className={`text-black mb-5 hover:scale-105 transition-transform duration-300 mb-1 ${snapshot.isDragging &&
                                            "inline"
                                            }`}
                                        >
